...
A WebAssembly (Wasm) runtime written in Rust following the [WebAssembly 1.0 spec](https://www.w3.org/TR/wasm-core-1/). Building it as an intersection between my interests in web infrastructure and interpreters. Usage examples can be found in [tests/examples_tests.rs](https://github.com/maklean/wasp/blob/main/tests/examples_tests.rs).
